...
# VALIDATION: This tells MongoDB to reject any data that doesn't match this shape.
# It's a second layer of defense after our Python Model.
...
class CommentRepository(ApplicationRepository):
    ...
    def on_init_collection(cls, collection: Collection) -> bool:
        # OPTIMIZATION: We create an 'Index'.
        # Why? Because we will mostly search for "All comments for Task X".
        # This makes that search 100x faster.
        ...
        try:
            ...
            if e.code == 26:
                # Code 26 means "Collection doesn't exist yet", so we create it.
