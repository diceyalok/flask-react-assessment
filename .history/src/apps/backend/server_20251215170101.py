...
print("------------------------------------------------")
print("DEBUG: SECRET_KEY is:", app.config.get('SECRET_KEY'))
print("DEBUG: JWT_SECRET_KEY is:", app.config.get('JWT_SECRET_KEY'))
print("------------------------------------------------")
# ----------------------------------------------
...
# Register comment apis  <-- ADD THIS BLOCK
...
if __name__ == "__main__":
    ...
    # debug=True allows hot-reloading (updates when you save files)
